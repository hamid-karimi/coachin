...
/**
 * Clickable card for an AI plan session. Neutral-tinted to sit apart from the
 * editable routine cards; the plan itself is edited in /training.
 */
export function PlanSessionCard({ item, onSelect }: { item: PlanItem; onSelect: (item: PlanItem) => void }) {
